...
!`command` runs at invocation time and its output is injected here.

You'll need the full authenticated one-liner (see TODO 4) piped through
`head -25`. Try the command in your terminal first — if it works there, it
works as dynamic context.
-->
